...
class Renderer:
    ...
    def render(
            ...
            drop_probability=0.0,  # New parameter to control the probability of dropping points
    ):
        ...
        # Drop points with a certain probability for providing volume generating
        if drop_probability > 0.0:
            opacity = torch.nn.functional.dropout(opacity, p=drop_probability, training=True)
